        ...
        <div className="flex items-center space-x-4 mt-4 md:mt-0">
          <button
            ...
            className={`flex items-center px-4 py-2 text-sm rounded-lg transition-colors duration-200 ${
              refreshing ? 'bg-gray-200 text-gray-500' : 'bg-white text-gray-700 hover:bg-gray-100'
            }`}
          >
          ...
          <button
            className="flex items-center px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-lg hover:from-indigo-700 hover:to-purple-700 transition-all duration-200 shadow-md hover:shadow-lg"
        ...
        <div className="bg-gradient-to-r from-green-500 to-emerald-500 p-6 rounded-2xl shadow-lg text-white">
          <div className="flex justify-between items-start mb-6">
            <div>
              ...
              <p className="text-green-100 text-opacity-80">All incoming funds</p>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        <div className="bg-white p-6 rounded-2xl shadow lg:col-span-2">
          <div className="flex justify-between items-center mb-6">
            <div>
              <h2 className="text-xl font-semibold text-gray-800">Weekly Transaction Overview</h2>
            ...
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={barData}>
                ...
                <Tooltip 
                  ...
                  formatter={(value) => [`$${value.toLocaleString()}`, value === 'credit' ? 'Credit' : 'Debit']}
        ...
        <div className="bg-white p-6 rounded-2xl shadow">
          <h2 className="text-xl font-semibold text-gray-800 mb-6">Balance Distribution</h2>
          <div className="h-64 mb-6">
            <ResponsiveContainer width="100%" height="100%">
              <PieChart>
                ...
                <Tooltip
                  formatter={(value) => [`$${value.toLocaleString()}`, pieData.find((d) => d.value === value)?.name]}
                />
                <Legend 
                  iconType="circle"
            ...
            <div className="pt-4 mt-4 border-t border-gray-100">
              <div className="flex items-center justify-between">
                ...
                <span className={`font-bold text-lg ${
                  (creditTotal - debitTotal) >= 0 ? 'text-green-500' : 'text-red-500'
                }`}>
                  ${Math.abs(creditTotal - debitTotal).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
