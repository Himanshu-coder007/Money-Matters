...
const Dashboard = () => {
  ...
  return (
    <div className="ml-64 p-8">
      ...
      <div className="bg-white p-6 rounded-xl shadow">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-semibold text-gray-700">Shopping</h2>
          <a href="diviagumtiedul.com" className="text-sm text-indigo-600 hover:underline">
            Buyer
          </a>
        </div>
        <p className="text-gray-600">Recent shopping activities and transactions.</p>
      </div>
